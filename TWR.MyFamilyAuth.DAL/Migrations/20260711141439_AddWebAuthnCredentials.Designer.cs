...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TWR.MyFamilyAuth.DAL.Entities.RegisteredApp", b =>
                {
                    ...
                    b.Property<string>("SupportedRoles")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
            ...
            modelBuilder.Entity("TWR.MyFamilyAuth.DAL.Entities.UserSetting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("FamilyUserId", "AppClientId", "SettingKey")
                        .IsUnique();

                    b.ToTable("UserSettings");
                });

            modelBuilder.Entity("TWR.MyFamilyAuth.DAL.Entities.WebAuthnChallenge", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("TWR.MyFamilyAuth.DAL.Entities.WebAuthnCredential", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
